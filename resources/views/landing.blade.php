...
<head>
    ...
    <title>{{ \App\Models\Setting::getVal('web_name', 'Photobox Studio') }} - Capture & Customize Memories</title>
    ...
    <header class="border-b border-purple-100 bg-white/40 backdrop-blur-md sticky top-0 z-40">
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                ...
                <span class="text-xl font-bold font-outfit text-purple-950">{{ \App\Models\Setting::getVal('web_name', 'Photobox Studio') }}</span>
            </div>
